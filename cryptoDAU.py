...
if solana_dau_response.status_code == 200 and cardano_dau_response.status_code == 200:
    ...
    #Instead of showing the plot, we will save the plot as an html file so that we can
    #integrate the plot into the Flask app
    plotly_file = "crypto_dau_plot.html"
    pyo.plot(fig, filename=plotly_file, auto_open=False)
    print("Plot saved as", plotly_file)
